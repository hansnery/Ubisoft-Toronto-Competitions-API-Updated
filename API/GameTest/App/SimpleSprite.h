...
public:
    ...
    bool m_flipX; // Variable to store horizontal flip state
    bool m_flipY; // Variable to store vertical flip state
    void SetFlip(bool flipX, bool flipY); // Method to set the flip state
